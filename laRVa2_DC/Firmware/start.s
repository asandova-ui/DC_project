...
test_mult:
 ...
 # We'll use registers t0-t6 for operands and results
 ...
 mulh t3, t0, t1   # MULH: t3 = 0 (high 32 bits, signed×signed)
 mulhsu t4, t0, t1 # MULHSU: t4 = 0 (high 32 bits, signed×unsigned)
 mulhu t5, t0, t1  # MULHU: t5 = 0 (high 32 bits, unsigned×unsigned)
 
 # Test case 2: Negative × Positive
 # -5 × 7 = -35 (0xFFFFFFDD in 32-bit, 0xFFFFFFFFFFFFFFDD in 64-bit)
 li t0, -5     # rs1 = -5 (0xFFFFFFFB)
 li t1, 7      # rs2 = 7
 mul t2, t0, t1    # MUL: t2 = -35 (0xFFFFFFDD)
 mulh t3, t0, t1   # MULH: t3 = -1 (0xFFFFFFFF, sign extension)
 mulhsu t4, t0, t1 # MULHSU: t4 = -1 (signed(-5) × unsigned(7) = -35, high=-1)
 mulhu t5, t0, t1  # MULHU: t5 = 7 (unsigned(0xFFFFFFFB=4294967291) × 7 = 0x70000001D, high=7)
 ...
 mul t2, t0, t1    # MUL: t2 = -35 (0xFFFFFFDD)
 mulh t3, t0, t1   # MULH: t3 = -1 (0xFFFFFFFF)
 mulhsu t4, t0, t1 # MULHSU: t4 = 4 (signed(5) × unsigned(0xFFFFFFF9) = 0x4FFFFFFF5 >> 32)
 mulhu t5, t0, t1  # MULHU: t5 = 4 (unsigned(5) × unsigned(0xFFFFFFF9) = 0x4FFFFFFF5 >> 32)
 ...
 mulh t3, t0, t1   # MULH: t3 = 0 (negative × negative = positive)
 mulhsu t4, t0, t1 # MULHSU: t4 = -5 (signed(-5) × unsigned(0xFFFFFFF9=4294967289) = -21474836445, high=-5)
 mulhu t5, t0, t1  # MULHU: t5 = 0xFFFFFFF6 (unsigned(0xFFFFFFFB) × unsigned(0xFFFFFFF9) = large, high bits)
 ...
 mulh t3, t0, t1   # MULH: high 32 bits (signed×signed)
 mulhsu t4, t0, t1 # MULHSU: high 32 bits (signed×unsigned)
 mulhu t5, t0, t1  # MULHU: high 32 bits (unsigned×unsigned)
 ...
 mulh t3, t0, t1     # MULH: t3 = 0 (signed: 2147483647 × 2 = 4294967294, high=0)
 mulhsu t4, t0, t1   # MULHSU: t4 = 0
 mulhu t5, t0, t1    # MULHU: t5 = 0
 ...
 mulh t3, t0, t1    # MULH: t3 = -1 (signed: -2147483648 × 2 = -4294967296, high=-1)
 mulhsu t4, t0, t1  # MULHSU: t4 = -1 (signed(-2147483648) × unsigned(2) = -4294967296, high=-1)
 mulhu t5, t0, t1   # MULHU: t5 = 1 (unsigned(0x80000000=2147483648) × 2 = 0x100000000, high=1)
 ...
 mulh t3, t0, t1    # MULH: t3 = -1 (signed: -1 × 2 = -2, high=-1)
