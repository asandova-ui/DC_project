...
test_mult:
 ...
 mulh a0, t0, t1   # MULH: a0 = 0 (high 32 bits, signed×signed)
 mulhsu a1, t0, t1 # MULHSU: a1 = 0 (high 32 bits, signed×unsigned)
 mulhu a2, t0, t1  # MULHU: a2 = 0 (high 32 bits, unsigned×unsigned)
 ...
 mulh a0, t0, t1   # MULH: a0 = -1 (0xFFFFFFFF, sign extension)
 mulhsu a1, t0, t1 # MULHSU: a1 = -1 (signed(-5) × unsigned(7) = -35, high=-1)
 mulhu a2, t0, t1  # MULHU: a2 = 7 (unsigned(0xFFFFFFFB=4294967291) × 7 = 0x70000001D, high=7)
 ...
 mul t2, t0, t1    # MUL: t2 = -35 (0xFFFFFFDD)
 mulh a0, t0, t1   # MULH: a0 = -1 (0xFFFFFFFF)
 mulhsu a1, t0, t1 # MULHSU: a1 = 4 (signed(5) × unsigned(0xFFFFFFF9) = 0x4FFFFFFF5 >> 32)
 mulhu a2, t0, t1  # MULHU: a2 = 4 (unsigned(5) × unsigned(0xFFFFFFF9) = 0x4FFFFFFF5 >> 32)
 ...
 mulh a0, t0, t1   # MULH: a0 = 0 (negative × negative = positive)
 mulhsu a1, t0, t1 # MULHSU: a1 = -5 (signed(-5) × unsigned(0xFFFFFFF9=4294967289) = -21474836445, high=-5)
 mulhu a2, t0, t1  # MULHU: a2 = 0xFFFFFFF6 (unsigned(0xFFFFFFFB) × unsigned(0xFFFFFFF9) = large, high bits)
 ...
 mulh a0, t0, t1     # MULH: a0 = 0 (signed: 2147483647 × 2 = 4294967294, high=0)
 mulhsu a1, t0, t1   # MULHSU: a1 = 0
 mulhu a2, t0, t1    # MULHU: a2 = 0
 ...
 mulh a0, t0, t1    # MULH: a0 = -1 (signed: -2147483648 × 2 = -4294967296, high=-1)
 mulhsu a1, t0, t1  # MULHSU: a1 = -1 (signed(-2147483648) × unsigned(2) = -4294967296, high=-1)
 mulhu a2, t0, t1   # MULHU: a2 = 1 (unsigned(0x80000000=2147483648) × 2 = 0x100000000, high=1)
 ...
 mulh a0, t0, t1    # MULH: a0 = -1 (signed: -1 × 2 = -2, high=-1)
 mulhsu a1, t0, t1  # MULHSU: a1 = -1 (signed(-1) × unsigned(2) = -2, high=-1)
 mulhu a2, t0, t1   # MULHU: a2 = 1 (unsigned(0xFFFFFFFF) × unsigned(2) = 0x1FFFFFFFE, high=1)
